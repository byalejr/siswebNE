...
class Vehiculos extends Controller{
    ...
    public function index()
    {
        ...
        $data['permisos'] = $this->model->verificarPermisos($id_user, "crear_vehiculo");
    ...
    public function listar()
    {
        ...
        $date = date('Y-m-d');
        $modificar = $this->model->verificarPermisos($id_user, "editar_vehiculo");
        $eliminar = $this->model->verificarPermisos($id_user, "eliminar_vehiculo");
    ...
    {
        $id_user = $_SESSION['id_usuario'];
        $data['permisos'] = $this->model->verificarPermisos($id_user, "restaurar_vehiculo");
        if (!empty($data['permisos']) || $id_user == 1) {
            $data['existe'] = true;
        } else {
            $data['existe'] = false;
