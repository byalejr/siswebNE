    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="formulario" onsubmit="modificarEmpresa(event)" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-floating mb-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="El nit es requerido">
                            ...
                            <label for="ruc"><i class="fas fa-id-card"></i> NIT <span class="text-danger fw-bold">*</span> </label>
                        </div>
                    </div>
                    <div class="col-md-6">
