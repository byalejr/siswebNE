...
<?php if ($data['existe']) { ?>
    ...
    <?php if (!empty($data['medidas']) || !empty($data['categorias'])) { ?>
        <button class="btn btn-outline-warning mb-2" type="button" data-bs-toggle="modal" data-bs-target="#base_datos"><i class="fas fa-cloud-upload-alt"></i></button>
<?php }
} ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <form id="frmBd" onsubmit="importar_productos(event)">
