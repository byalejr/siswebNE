...
<body>
    ...
    <div class="container-login">
        <div class="img">
            <img src="<?php echo base_url; ?>Assets/img/avatar12.png">
        </div>
        <div class="login-content">
            <form id="frmLogin" class="form" onsubmit="frmLogin(event)" autocomplete="off">
                <img src="<?php echo base_url; ?>Assets/img/avatar1.png">
                <h3 class="title">Sindicato de Transporte Pesado Nueva Esperanza</h3>
