...
<?php } ?>
<?php if ($data['reporte']) { ?>
    <button class="btn btn-outline-danger mb-2" type="button" onclick="generarPdfPrestamos()"><i class="fas fa-file-pdf"></i></button>
<?php } ?>
<div class="card">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title" id="title">Nuevo Contrato</h5>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="select_cliente">Buscar Socio <span class="text-danger fw-bold">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-floating mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="precio">Costo del servicio <span class="text-danger fw-bold">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        <input id="abono" class="form-control" type="text" name="abono" placeholder="Abono" required>
                                        <label for="abono">Abono Socio <span class="text-danger fw-bold">*</span></label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
        ...
        <div class="modal-content">
            ...
            <form id="procesarEntrega" onsubmit="procesarEntrega(event)">
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <input id="monto_pagar" class="form-control" type="hidden" placeholder="Monto a Pagar" disabled>
                        <label type=hidden for="monto_pagar"></label>
                    </div>
                </div>
                <div class="modal-footer">
