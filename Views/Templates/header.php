...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar-->
        <a class="navbar-brand ps-3" href="<?php echo base_url; ?>Administracion/home">Nueva Esperanza</a>
        <!-- Sidebar-->
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseCaja" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="<?php echo base_url; ?>Cajas/arqueo">Arqueo Caja</a>
                            </nav>
                        </div>
                        ...
                        <a class="nav-link" href="<?php echo base_url; ?>Alquiler/pdfAlquiler/all" target="_blank">
